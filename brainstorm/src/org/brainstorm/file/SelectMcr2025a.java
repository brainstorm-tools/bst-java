 ...
 */
public class SelectMcr2025a {
    // ===== CONSTRUCTOR =====
    public SelectMcr2025a(){
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT2501.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null,
                ...
                "Matlab Runtime 25.1 on your computer (R2025a).\n\n" +
                "The Runtime is available from the Mathworks website:\n" +
                "> google \"download matlab runtime\".\n\n" +
                "Now, select the installation folder of the Runtime 25.1. Examples:\n" +
                "    - Linux:  /usr/local/MATLAB/MATLAB_Runtime/R2025a\n" +
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/R2025a\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\R205a\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (25.1)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 25.1 installation folder");
            System.exit(-1);
        }
