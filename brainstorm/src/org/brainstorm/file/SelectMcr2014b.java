 ...
 */
public class SelectMcr2014b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2014b(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT84.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Compiler Runtime 8.4 on your computer (MCR Matlab R2014b).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 8.4. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Compiler_Runtime/v84\n" +
                "    - Linux:  $HOME/MCR_R2014b\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Compiler_Runtime/v84\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Compiler Runtime\\v84\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Compiler Runtime folder (8.4)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Compiler Runtime 8.4 installation folder");
            System.exit(-1);
        }
