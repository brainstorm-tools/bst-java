 ...
 */
public class SelectMcr2024b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2024b(){
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT2402.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null,
                ...
                "Matlab Runtime 24.2 on your computer (R2024b).\n\n" +
                "The Runtime is available from the Mathworks website:\n" +
                "> google \"download matlab runtime\".\n\n" +
                "Now, select the installation folder of the Runtime 24.2. Examples:\n" +
                "    - Linux:  /usr/local/MATLAB/MATLAB_Runtime/R2024b\n" +
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/R2024b\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\R2024b\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (24.2)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 24.2 installation folder");
            System.exit(-1);
        }
