 ...
 */
public class SelectMcr2016b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2016b(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT91.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.1 on your computer (MCR Matlab R2016b).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 9.1. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v91\n" +
                "    - Linux:  $HOME/MCR_R2016b\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v91\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v91\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.1)");
