 ...
 */
public class SelectMcr2017b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2017b(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT93.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.3 on your computer (MCR Matlab R2017b).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 9.3. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v93\n" +
                "    - Linux:  $HOME/MCR_R2017b\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v93\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v93\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.3)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 9.3 installation folder");
            System.exit(-1);
        }
