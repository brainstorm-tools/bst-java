 ...
 */
public class SelectMcr2018a {
    // ===== CONSTRUCTOR =====
    public SelectMcr2018a(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT94.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.4 on your computer (MCR Matlab R2018a).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 9.4. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v94\n" +
                "    - Linux:  $HOME/MCR_R2018a\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v94\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v94\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.4)");
