 ...
 */
public class SelectMcr2020a {
    // ===== CONSTRUCTOR =====
    public SelectMcr2020a(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT98.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.8)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 9.8 installation folder");
            System.exit(-1);
        }
