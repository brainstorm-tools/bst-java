 ...
 */
public class SelectMcr2015b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2015b(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT90.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.0 on your computer (MCR Matlab R2015b).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 9.0. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v90\n" +
                "    - Linux:  $HOME/MCR_R2015b\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v90\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v90\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.0)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 9.0 installation folder");
            System.exit(-1);
        }
