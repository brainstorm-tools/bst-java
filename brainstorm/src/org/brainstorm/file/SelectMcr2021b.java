 ...
 */
public class SelectMcr2021b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2021b(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT911.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.11 on your computer (MCR Matlab R2021b).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 9.11. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v911\n" +
                "    - Linux:  $HOME/MCR_R2021b\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v911\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v911\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.11)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 9.11 installation folder");
            System.exit(-1);
        }
