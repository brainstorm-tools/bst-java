 ...
 */
public class SelectMcr2022b {
    // ===== CONSTRUCTOR =====
    public SelectMcr2022b(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT913.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.13 on your computer (R2022b).\n\n" +
                "The Runtime is available from the Mathworks website:\n" + 
                "> google \"download matlab runtime\".\n\n" + 
                "Now, select the installation folder of the Runtime 9.13. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v913\n" +
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v913\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v913\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.13)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 9.13 installation folder");
            System.exit(-1);
        }
