 ...
 */
public class SelectMcr2023a {
    // ===== CONSTRUCTOR =====
    public SelectMcr2023a(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT914.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.14 on your computer (R2023a).\n\n" +
                "The Runtime is available from the Mathworks website:\n" + 
                "> google \"download matlab runtime\".\n\n" + 
                "Now, select the installation folder of the Runtime 9.14. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v914\n" +
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v914\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v914\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.14)");
        ...
        if (!(new File(mcrDir + "/bin/maci64/libnativedl.jnilib")).isFile() &&
            ...
            JOptionPane.showMessageDialog(null, "Not a valid Matlab Runtime 9.14 installation folder");
            System.exit(-1);
        }
