 ...
 */
public class SelectMcr2017a {
    // ===== CONSTRUCTOR =====
    public SelectMcr2017a(){     
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File confFile = new File(userDir + "/.brainstorm/MATLABROOT92.txt");
        String mcrDir = "";
        // Read file
        if (confFile.isFile()){
            try {
        ...
        JOptionPane.showMessageDialog(null, 
                ...
                "Matlab Runtime 9.2 on your computer (MCR Matlab R2017a).\n\n" +
                "The MCR is available from the Mathworks website:\n" + 
                "> google \"download matlab mcr\".\n\n" + 
                "Now, select the installation folder of the MCR 9.2. Examples:\n" +
                "    - Linux:  /usr/local/Matlab_Runtime/v92\n" +
                "    - Linux:  $HOME/MCR_R2017a\n" + 
                "    - MacOSX: /Applications/MATLAB/MATLAB_Runtime/v92\n" +
                "    - Windows: C:\\Program Files\\MATLAB\\MATLAB Runtime\\v92\n");

        // Show dialog box
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setDialogTitle("Select Matlab Runtime folder (9.2)");
