...
public class BstImageView extends View {
    ...
    public BstImageView(Element elem) {
        super(elem);
    ...
    private class ImageHandler implements ImageObserver {
        ...
        public boolean imageUpdate(Image img, int flags, int x, int y,
            ...
            if ((flags & (ABORT|ERROR)) != 0) {
                repaint(0);
                synchronized(BstImageView.this) {
                    if (image == img) {
    ...
    private void loadImage() {
        ...
        if (src != null) {
            ...
            try {
                ...
                ByteArrayInputStream bais = new ByteArrayInputStream(decoder.decodeBuffer(b64));
