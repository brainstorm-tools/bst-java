...
public class IconLoader {
    ...
    public static final ImageIcon ICON_FEM           = createImageIcon("icon/iconFem.gif");
    ...
    public static final ImageIcon ICON_COLORMAP_TURBO        = createImageIcon("icon/iconColormapTurbo.gif");
