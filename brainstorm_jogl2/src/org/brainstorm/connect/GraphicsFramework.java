...
import javax.media.opengl.awt.*;    // JOGL2
...
public class GraphicsFramework extends GLCanvas implements GLEventListener {
    ...
    /* Text modifiers */
    public void setNodeText(final int index, final String text) {
    ...
    public void setTextTransparency(final int[] indices, final float iA) {
        invoke(false, new GLRunnable() {
                public boolean run(GLAutoDrawable gf) {
                    for (int i = 0; i < indices.length; ++i) {
    ...
    public void setTextVisible(final int[] indices, final boolean visible) {
        invoke(false, new GLRunnable() {
                public boolean run(GLAutoDrawable gf) {
                    for (int i = 0; i < indices.length; ++i) {
    ...
    public void setTextSize(final int[] indices, final float iSize) {
        invoke(false, new GLRunnable() {
                public boolean run(GLAutoDrawable gf) {
                    for (int i = 0; i < indices.length; ++i) {
    ...
    public void setTextPosition(final int[] indices, final float[] iX, final float[] iY, final float[] iZ) {
        invoke(false, new GLRunnable() {
                public boolean run(GLAutoDrawable gf) {
                    for (int i = 0; i < indices.length; ++i) {
    ...
    public void setTextOrientation(final int[] indices, final float[] iAngle) {
        invoke(false, new GLRunnable() {
                public boolean run(GLAutoDrawable gf) {
                    for (int i = 0; i < indices.length; ++i) {
    ...
    public void setTextAlignment(final int[] indices, final int al) {
        invoke(false,
            new GLRunnable() {
                public boolean run(GLAutoDrawable gf) {
                    for (int i = 0; i < indices.length; ++i) {
